...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Request body JSON:', JSON.stringify(loginData));
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ color: "#05668D", mb: 3, textAlign: "center" }}>
          Login to continue
        </Typography>
        ...
        <Typography sx={{ mt: 3, color: "#05668D", textAlign: "center" }}>
